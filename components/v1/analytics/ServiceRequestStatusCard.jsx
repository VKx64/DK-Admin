...
const ServiceRequestStatusCard = ({ data, PIE_COLORS }) => {
  if (!data || data.length === 0) {
    return (
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h4 className="text-lg font-semibold mb-4">Service Request Statuses</h4>
...
export default ServiceRequestStatusCard;
